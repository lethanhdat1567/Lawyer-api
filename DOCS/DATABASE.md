...
- Mọi bảng domain chính: **`created_at`**, **`updated_at`**; **soft delete** `deleted_at` khi có nội dung user-generated hoặc cần khôi phục.
...
| Bảng                        | Mô tả                                                                                                                                                            |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `assistant_conversations`   | `user_id`, `title` (nullable); `created_at`, `updated_at`, `deleted_at`.                                                                                         |
...
| Bảng             | Mô tả                                                                                                                                                                                                                             |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `blog_posts`     | `author_id`, `slug` (unique), `title`, `excerpt`, `body`, `status`: `DRAFT`, `PUBLISHED`; `is_verified`, `verified_at`, `verified_by_user_id` (nullable), `verification_notes`, `legal_corpus_version`; timestamps, `deleted_at`. |
